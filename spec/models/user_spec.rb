...
describe User do
	...
	before { @user = User.new(name: "Chee Peng", email: "v.handed@gmail.com", password: "foobar", password_confirmation: "foobar") }
	...
	describe "when password pair mismatch" do
	...
	describe "return value of authenticate method" do
		...
		describe "with a password that is too slow" do
